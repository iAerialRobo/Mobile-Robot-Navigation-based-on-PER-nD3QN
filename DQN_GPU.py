...
class DQN(object):
    def __init__(self):  # 定义DQN的一系列属性
        ...
        self.mean_eval=0.0
        if  load_models:
            checkpoint = torch.load("/home/wendy/RLprojects/ros_pytorch/src/dqn/src/Models/stage_4/dqn/1050a.pt")
    ...
    def learn(self):                                                            # 定义学习函数(记忆库已满后便开始学习)
        ...
        # 抽取记忆库中的批数据
            ...
            q_target = b_r + GAMMA * judge * q_next.max(1)[0].view(BATCH_SIZE, 1)
...
if __name__=='__main__':
    ...
    rewards=[]
    success_rates=[]
    writer = SummaryWriter("/home/wendy/RLprojects/ros_pytorch/src/dqn/src/logs/dqn")
if  load_models:
        checkpoint = torch.load("/home/wendy/RLprojects/ros_pytorch/src/dqn/src/Models/stage_4/dqn/1050a.pt")
